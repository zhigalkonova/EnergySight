...
VALUES
    ...
    ('Сосновка',               'узел',            'Наурзумский', 51.6420, 64.4306, 'норма', now() - interval '45 days'),
    ('Буревестник',            'узел',            'Наурзумский', 50.9641, 64.3725, 'норма', now() - interval '60 days'),
    ('Семилетка',              'узел',            'Наурзумский', 51.7902, 64.8905, 'норма', now() - interval '20 days'),
    ('Шолоксай',               'узел',            'Наурзумский', 52.1186, 64.8950, 'норма', now() - interval '15 days'),
    ('Ушакова',                'узел',            'Наурзумский', 51.6737, 65.1183, 'норма', now() - interval '50 days'),
    ('Панфилова',              'узел',            'Наурзумский', 51.5466, 65.0825, 'норма', now() - interval '25 days'),
    ...
    ('РП-10 кВ "п.Аксай"',     'РП',              'Наурзумский', 51.0488, 65.1093, 'норма', now() - interval '40 days'),
    ('ПС Кожахмет',            'ПС (демонтирована)', 'Наурзумский', 50.5404, 64.9843, 'демонтирован', NULL);
